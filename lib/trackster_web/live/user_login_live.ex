defmodule TracksterWeb.UserLoginLive do
  ...
  def render(assigns) do
    ...
    <div class="flex items-center justify-center h-screen">
      <!-- Login Container -->
      <div class="min-w-fit flex-col border bg-brand/5 px-6 py-14 shadow-md rounded-[4px] ">
        <.simple_form for={@form} id="login_form" action={~p"/users/log_in"} phx-update="ignore">
          <div class="mb-8 flex justify-center">
            <a href="/">
              <img class="w-24" src={~p"/images/logo.svg"} />
            </a>
          </div>

          <div class="flex flex-col text-sm rounded-md">
            <.input
              class="mb-5 rounded-[4px] border p-3"
              field={@form[:email]}
              type="email"
              label="Email"
              required
          ...
          <div class="mt-5 flex justify-between text-sm text-gray-600">
            <.link href={~p"/users/reset_password"} class="text-sm font-semibold hover:text-gray-900">
              Forgot your password?
            </.link>
            <.link navigate={~p"/users/register"} class="font-semibold hover:text-gray-900">
              Register
            </.link>
          </div>
          ...
          <div class="mt-5 flex text-center text-sm text-gray-400">
            <p>
              ...
              and <a class="underline" href="">Terms of Service</a>
              apply.
            </p>
          </div>
        </.simple_form>
