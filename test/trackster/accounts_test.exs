defmodule Trackster.AccountsTest do
  ...
  describe "private_keys" do
    ...
    test "create_private_key/1 with valid data creates a private_key" do
      ...
      assert {:ok, %PrivateKey{} = private_key} = Accounts.create_private_key(valid_attrs)
    end

    test "create_private_key/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = Accounts.create_private_key(@invalid_attrs)
    end
    ...
    test "update_private_key/2 with valid data updates the private_key" do
      ...
      assert {:ok, %PrivateKey{} = private_key} = Accounts.update_private_key(private_key, update_attrs)
    end
    ...
    test "change_private_key/1 returns a private_key changeset" do
      private_key = private_key_fixture()
      assert %Ecto.Changeset{} = Accounts.change_private_key(private_key)
    end
  end
end
